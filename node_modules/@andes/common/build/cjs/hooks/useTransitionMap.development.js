...
const useTransitionMap = function () {
  ...
  const _useState = react.useState(initialStateMap),
  ...
  const _getTimeout = getTimeout(timeout),
    _getTimeout2 = _slicedToArray__default["default"](_getTimeout, 2),
  ...
  const deleteItem = react.useCallback(/** @param {any} key */
  key => {
  ...
  const endTransition = react.useCallback(/** @param {any} key */
  key => {
  ...
  const toggleAll = react.useCallback(/** @param {boolean} [toEnter] */
  toEnter => {
